                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      ...
                      {userList.users.map((user, findex) => {
                        return (
                          ...
                          <tr className="border-neutral-500 border-t-2">
                            <td className="text-start px-6 whitespace-nowrap text-l font-mono text-orange-600">{user.name}</td>
                            <td className="text-start px-6 whitespace-nowrap text-sm font-normal text-gray-800">
                              {user.email}
                            </td>
                            <td className="text-center px-6 whitespace-nowrap text-sm font-normal text-gray-800">
                      ...
                      <tr>
                        <td className="px-1 py-1">
                          <input type="text" ref={filterUserRef} name="filterUser" placeholder="Search Users" className="px-2 py-1 text-sm border border-gray-300 rounded-lg" />
